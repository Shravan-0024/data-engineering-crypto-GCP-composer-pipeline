...
BigQueryTableLink.persist = staticmethod(lambda **kwargs: None)
...
GCP_PROJECT = "bitcoin-airlfow-orchestration"
GCS_BUCKET = "crypto-exchange-pipeline-sannu"
